...
const links = [
  {
    label: `Cursos`,
    href: `https://pay.hotmart.com/L63442499V?checkoutMode=10&bid=1643700313777`,
  },
    ...
    <nav className={tw(`bg-white`)}>
      <div className={tw(`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8`)}>
        <div className={tw(`flex items-center justify-between h-24`)}>
          ...
          <div className={tw(`hidden md:block`)}>
            <div className={tw(`ml-4 flex items-center md:ml-6 space-x-3 `)}>
           
            
            <Button  primary><a href="https://pancakeswap.finance/"> Compre Destarter na PancakeSwap </a></Button>
